# Lab02
Using a Firebase Realtime Database (https://console.firebase.google.com/u/9/project/iotgroup15b-lab02/database),
the `nodeimu` and `sense-hat-led` libraries, and the Raspberry Pi Sense HAT:
